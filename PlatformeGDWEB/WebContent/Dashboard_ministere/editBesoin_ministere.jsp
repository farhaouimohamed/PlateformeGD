...
<div class="container">	
	...
	<form name="formEditBesoin" action="editBesoinMinistere?idBesoin=${besoin.getIdBesoin()}" method="post" class="col-md-6 col-md-offset-3 form-box-cha9a9a">
	...
	<!--   </div> -->
		...
		<div class="form-group" >
			 ...
			 <a href="besoinMinistere?idBesoin=${besoin.getIdBesoin()}" class="btn btn-default btn-block" role="button">Annuler</a>
	  	</div>
	</form>
</div>
</section>
