...
@WebServlet(urlPatterns = { "/reglement_spontanne" })
@MultipartConfig
public class FaireUnDonReglementSpontanne extends HttpServlet{
	@EJB
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		req.getRequestDispatcher("Dashboard_donateur/faireUnDonReglementSpontannee.jsp").forward(req, resp);
	}
