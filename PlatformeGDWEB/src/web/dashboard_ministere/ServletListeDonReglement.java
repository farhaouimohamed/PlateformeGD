...
@WebServlet(urlPatterns = {"/Liste_Dons_Reglement"})
public class ServletListeDonReglement extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<Reglement> dons_reglement = metier.getAllDonsReglement(currentPage, GlobalConfig.recordsPerPage, order, direction);
		int rows = (int) metier.getNumberOfRows("Reglement");
		...
		req.setAttribute("dons_reglement", dons_reglement);
		req.getRequestDispatcher("Dashboard_ministere/ListeDnReglement.jsp").forward(req,resp);
	}
	@Override
