			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 form-box-cha9a9a">
						<hr>
						<form name="formResetPwd" method="post"
							action="resetPwd"
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label required" for="password">Nouveau mot de passe</label> </i><span class="required text-danger form-asterisk"
